...
@section('main')
    ...
    <form action="{{ route('alterar_fornecedor', $fornecedor->id) }}" method="POST">
        ...
        <div class="form-group col-sm-12">
            ...
            <input id="endereco" value="{{$fornecedor->endereco}}" class="col-sm-12 col-md-9" type="text"
                   name="endereco"><br/>
        </div>
        <div class="form-group col-sm-12">
        ...
        <div class="form-group col-sm-12">
            ...
            <input id="telefone" value="{{$fornecedor->telefone}}" class="col-sm-12 col-md-9" type="text"
                   name="telefone"><br/><br/>
        </div>
